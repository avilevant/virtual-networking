...
import editProfile from '../../img/menuicons/Icons for dror-55.png';
import myProfile from '../../img/menuicons/Icons for dror-50 new-55.png';
...
class SideMenu extends React.Component{
    ...
    this.setState(
      ...
      userImage:editProfile, userName:'Please Sign In'
    } 
      
    )
  }else  {
    console.log(this.props.sideImg)
    this.setState(
      ...
      userImage:this.props.sideImg,userName:C_name
    }
    ...
    render(){
        let menuImg =  this.props.sideImg
      ...
      return(
          ...
          <nav className= {classNamesMenu}>
              ...
              <img src={menuImg||editProfile} alt='user' className='smallImg1'  /> 
              </div>
